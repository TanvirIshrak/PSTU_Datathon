...
cells.append(code(
    ...
    "        out[f'row_q{int(q*100)}'] = ref.loc[q].values.astype('float32')  # broadcast",
    "    return out, ref",
    "",
...
cells.append(code(
    ...
    "        random_strength=rs, bagging_temperature=bt,",
    "        random_seed=seed, task_type=task_type,",
    "        bootstrap_type='Bayesian' if bt > 0 else 'Bernoulli',",
    "    )",
    "",
    "search_results = []",
    "t0 = time.time()",
